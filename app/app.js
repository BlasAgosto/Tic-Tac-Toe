...
function wheener () {
  if (pain[0] === pain[1] && pain[0] === pain[2]) { dumb(dumber(0)) }
  if (pain[3] === pain[4] && pain[3] === pain[5]) { dumb(dumber(3)) }
  if (pain[6] === pain[7] && pain[6] === pain[8]) { dumb(dumber(6)) }
  if (pain[0] === pain[3] && pain[0] === pain[6]) { dumb(dumber(0)) }
  if (pain[1] === pain[4] && pain[1] === pain[7]) { dumb(dumber(1)) }
  if (pain[2] === pain[5] && pain[2] === pain[8]) { dumb(dumber(2)) }
  if (pain[0] === pain[4] && pain[0] === pain[8]) { dumb(dumber(0)) }
  if (pain[6] === pain[4] && pain[6] === pain[2]) { dumb(dumber(6)) }
  // else { alert('how are you this bad!? You tied! <br> CAT GAME!') }
}
